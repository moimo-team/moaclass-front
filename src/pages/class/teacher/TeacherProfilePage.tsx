...
const TeacherProfilePage = () => {
  ...
  const [teacherProfile, setTeacherProfile] = useState<TeacherProfile | null>(MOCK_TEACHER_PROFILE);
    ...
    <div className="w-full">
      <div className="space-y-12">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <h4 className="text-xl font-bold text-gray-900">{teacherProfile.nickname}</h4>
