 ...
 */
const mapPointTypeToTab = (type: PointType): Exclude<TabStatus, "전체"> => {
  const statusMap: Record<PointType, Exclude<TabStatus, "전체">> = {
    CHARGE: "적립",
    USE: "사용",
    REFUND: "적립",
  };
...
const Points = () => {
  ...
  const filteredHistory = useMemo(() => {
    ...
    return userPoints.filter((point) => {
      ...
      return mapPointTypeToTab(point.type) === activeTab;
    });
  }, [userPoints, activeTab]);
