      ...
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden gap-0 border-none shadow-2xl">
        <DialogHeader className="p-6 pb-4 border-b bg-gray-50/50">
          <div className="space-y-1">
            <DialogTitle className="text-xl font-black text-gray-900 tracking-tight">모멘티 명단</DialogTitle>
        ...
        <div className="max-h-[500px] overflow-y-auto px-6 py-4 space-y-4 bg-white scrollbar-hide">
          {isLoading ? (
            <div className="py-24 text-center">
              <LoadingSpinner />
              <p className="mt-4 text-sm text-gray-400 font-extrabold tracking-tight">명단을 불러오는 중입니다...</p>
            </div>
            ...
            <div className="py-24 text-center space-y-4">
              ...
              <p className="text-sm text-gray-400 font-extrabold tracking-tight">해당 일정에 모멘티가 없습니다.</p>
            </div>
          ) : (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-2">
                      <span className="font-black text-[15px] text-gray-900 leading-none">{participant.nickname}</span>
                      <Badge variant="secondary" className="bg-carrot/10 text-carrot hover:bg-carrot/20 text-[10px] font-black px-1.5 py-0 h-4 border-none">
                        모멘티
                      </Badge>
                    </div>
                  </div>
