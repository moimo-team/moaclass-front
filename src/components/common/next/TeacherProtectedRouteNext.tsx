...
interface TeacherProtectedRouteNextProps {
	children: React.ReactNode;
}

const TeacherProtectedRouteNext = ({ children }: TeacherProtectedRouteNextProps) => {
...
export default TeacherProtectedRouteNext;
