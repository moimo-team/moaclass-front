...
## 16. OG 이미지 제작 가이드 (Slack · 카카오톡 · Discord 공통)

### 16.1 목적

- 링크 공유 시 썸네일, 제목, 설명이 플랫폼별로 안정적으로 노출되도록 OG 이미지 제작 기준을 고정합니다.
...
### 16.3 브랜드 적용 기준 (현재 토큰)

- Primary: `#6B8F71`
- Secondary: `#A9C3B0`
- Accent Tint: `#DFECE3`, `#F3F5F2`
- Highlight: `#F97316`
- Text Dark: `#2F2F2F`
- 브랜드 요소: `public/moaclass-icon.svg` 모티프(원형 링 + M/C + 오렌지 포인트)
...
- 헤드라인: 서비스 가치 문장 1개
- 서브라인: 원데이 클래스/모임 범용 문구
- 배경: primary 기반 그라데이션 + 약한 패턴

2. `og-lessons.png`

- 헤드라인: 원데이 클래스 중심 문구
- 시각 요소: 카드형 프레임/썸네일 느낌
- 오렌지 강조색은 CTA성 포인트로만 제한
...
- 설명: 28~36px
- 권장 줄수: 제목 1~2줄, 설명 1줄
- 금지: 3줄 이상 제목, 작은 본문 다량 배치

### 16.6 경로 규칙

- `public/og/og-home.png`
- `public/og/og-lessons.png`
- `public/og/og-meetings.png`
